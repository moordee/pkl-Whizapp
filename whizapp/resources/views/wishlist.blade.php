...
.btn-select:hover { background: #4e3dbf; }
.btn-select.active { background: #6c4ee0; }
...
.btn-bulk-delete:hover { opacity: 1; }
...
body.select-mode .btn-delete      { display: none; }
body.select-mode .btn-bulk-delete { display: block; }
...
<!-- ══ TOPBAR ══ -->
<div class="topbar">
    <img src="https://img.icons8.com/ios-filled/30/ffffff/menu--v1.png" class="menu-toggle" onclick="toggleSidebar()">
    ...
    <div class="content">
        ...
        <div class="content-toolbar">
            <div class="ms-auto d-flex align-items-center gap-2">
                ...
                <button class="btn-bulk-delete" id="btnBulkDelete" onclick="deleteSelected()" aria-label="Delete selected">
                    <img src="Delete.png" alt="Delete selected" />
                </button>
            </div>
        </div>
        ...
        <div class="wishlist-card" id="card-1">
            ...
            <button class="btn-delete" onclick="removeCard('card-1')" aria-label="Delete">
                <img src="DeleteHitam.png" alt="Delete" />
            </button>
